...
class PullRequestStore {
  ...
  loadPullRequests() {
    ...
    let repos = ["symopsio/platform", "symopsio/webapp", "symopsio/sym-flow-cli", "symopsio/sym-sdk", "symopsio/sym-demo-terraform", "symopsio/terraform-google-gcp-connector"]
